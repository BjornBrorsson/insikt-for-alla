        ...
        <div className="space-y-10 text-foreground">
          ...
          <section className="rounded-xl border border-border bg-card p-6 shadow-xs">
            ...
            <p className="mt-4 text-xs text-muted-foreground">
              Insikt ändrar aldrig i källdata från riksdagen. Om en uppgift saknas i källan visas den
              som ”Uppgift saknas” i Insikt.
            </p>
          </section>
          ...
          <section className="rounded-xl border border-border bg-card p-6 shadow-xs">
            ...
            <p className="mt-3 text-muted-foreground leading-relaxed">
              ...
              sammanställningar. Dessa är tydligt märkta som Insikts egna beräkningar och följer strikt
              definierade regler:
            </p>
            ...
            <div className="mt-6 space-y-6">
              <div className="border-l-2 border-[var(--accent-insikt)] pl-4">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  <em>Viktig notering:</em> Detta är en rent matematisk observation av hur ledamöterna
                  faktiskt röstade, inte nödvändigtvis partiets formella partilinje eller partipiska. Om
                  två alternativ får exakt lika många röster saknar partiet entydig majoritetsröst i den
                  voteringen.
                </p>
              </div>
              ...
              <div className="border-l-2 border-[var(--accent-insikt)] pl-4">
                ...
                <p className="my-2 rounded bg-muted/50 p-2 font-mono text-xs">
                  Röstlikhet = (Antal omröstningar med samma röst) / (Antal jämförbara omröstningar) × 100
                </p>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Som standard räknas en omröstning som <strong>jämförbar</strong> enbart när båda
                  aktörerna avgav en aktiv röst (Ja, Nej eller Avstår). Frånvaro och voteringar där ett
                  parti saknade entydig majoritetsröst exkluderas ur beräkningen och redovisas separat.
                </p>
                <p className="mt-1 text-xs text-muted-foreground">
                  <em>Tolkning:</em> Röstlikhet visar rent faktiskt hur ofta ledamöterna tryckt på samma
                  knapp. Det är inte ett bevis på ideologisk gemenskap, dolt samarbete eller gemensamma
                  politiska motiv.
                </p>
              </div>
              ...
              <div className="border-l-2 border-[var(--accent-insikt)] pl-4">
                ...
                <p className="my-2 rounded bg-muted/50 p-2 font-mono text-xs">
                  Sammanhållning = (Avgivna röster i linje med majoritetsrösten) / (Totalt avgivna röster
                  i partiet) × 100
                </p>
                <p className="text-xs text-muted-foreground">
                  Endast Ja, Nej och Avstår räknas som avgivna röster. Frånvarande ledamöter påverkar
                  inte sammanhållningsmåttet.
                </p>
              </div>
              ...
              <div className="border-l-2 border-[var(--accent-insikt)] pl-4">
                ...
                <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
                  ...
                  överenskommer att ledamöter avstår från att rösta så att styrkeförhållandena i kammaren
                  inte rubbas när ledamöter är sjuka, föräldralediga eller deltar i internationella
                  delegationer. En ledamot som är frånvarande i kammarens voteringar kan vara fullt upptagen
                  med utredningsarbete, utskottsmöten eller ministeruppdrag.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-xl border border-border bg-card p-6 shadow-xs">
            ...
            <p className="mt-3 text-muted-foreground leading-relaxed">
              Riksdagens egen ärendedatabas saknar en enhetlig konsumentanpassad ämnestaggning. Insikt har
              därför tagit fram 10 centrala sakfrågeområden (t.ex. Klimat och miljö, Energi, Skola,
              Sjukvård, Rättspolitik m.fl.).
            </p>
            <p className="mt-3 text-muted-foreground leading-relaxed">
              Ärenden kopplas till dessa sakfrågor baserat på ansvarigt riksdagsutskott och specifika
              nyckelord i betänkandenas titlar. Varje sådan koppling märks i gränssnittet som{" "}
              <em>”Insikts kategorisering”</em> för att inte förväxlas med en officiell klassificering
              från riksdagen.
            </p>
          </section>
          ...
          <section className="rounded-xl border border-border bg-card p-6 shadow-xs">
            ...
            <ul className="mt-3 list-disc pl-6 space-y-1.5 text-sm text-muted-foreground">
              ...
              <li>
                Om underlaget inte räcker för en tillförlitlig sammanfattning anges detta uttryckligen.
              </li>
            </ul>
          </section>
        </div>
