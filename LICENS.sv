...
—
originalverk
: det verk eller den programvara som sprids eller kommuniceras av licensgivaren enligt denna licens och som, beroende på omständigheterna, är tillgänglig i form av källkod eller exekverbar kod.
—
härledda verk
: de verk eller den programvara som licenstagaren kan skapa på grundval av originalverket eller nya versioner av detta. I denna licens definieras inte den grad av ändring eller det beroende av det ursprungliga verket som krävs för en klassificering som härlett verk. Detta bestäms enligt den upphovsrättslagstiftning som är tillämplig i det land som anges i artikel 15.
—
verket
: originalverket eller verk som är härledda från detta.
—
källkod
: den för människan läsbara formen av verket, som lättast kan granskas och ändras av människor.
—
den exekverbara koden
: all kod som i allmänhet kompilerats och som är avsedd att läsas som ett program av en dator.
—
licensgivaren
: den fysiska eller juridiska person som sprider eller kommunicerar det verk som licensen gäller.
—
bidragslämnare
: en fysisk eller juridisk person som bearbetar det verk licensen gäller, eller på annat sätt bidrar till att skapa ett härlett verk.
—
licenstagaren eller du
: en fysisk eller juridisk person som använder verket enligt villkoren i licensen.
—
spridning eller kommunikation
: varje handling som syftar till att sälja, ge, låna ut, hyra ut, distribuera, kommunicera, sända eller på annat sätt, online eller offline, göra kopior av verket tillgängliga eller ge tillgång till dess väsentliga funktioner för en annan fysisk eller juridisk person.
